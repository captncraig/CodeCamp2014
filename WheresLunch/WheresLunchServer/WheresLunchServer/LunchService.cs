...
namespace WheresLunchServer
{
  public partial class LunchService {
    public interface Iface {
      ...
      #endif
      void PlaceVote(Vote v);
      #if SILVERLIGHT
      IAsyncResult Begin_PlaceVote(AsyncCallback callback, object state, Vote v);
    ...
    public class Client : IDisposable, Iface {
      ...
      #if SILVERLIGHT
      public IAsyncResult Begin_PlaceVote(AsyncCallback callback, object state, Vote v)
      {
        return send_PlaceVote(callback, state, v);
      }
      ...
      public void PlaceVote(Vote v)
      {
        ...
        #else
        var asyncResult = Begin_PlaceVote(null, null, v);
        End_PlaceVote(asyncResult);

        #endif
      }
      #if SILVERLIGHT
      public IAsyncResult send_PlaceVote(AsyncCallback callback, object state, Vote v)
      #else
      public void send_PlaceVote(Vote v)
      #endif
      {
    ...
    public class Processor : TProcessor {
      ...
      public void PlaceVote_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        PlaceVote_result result = new PlaceVote_result();
        try {
          iface_.PlaceVote(args.V);
        } catch (AlreadyVotedException a) {
          result.A = a;
        }
    ...
    {
      private AlreadyVotedException _a;

      public AlreadyVotedException A
      {
        get
        {
          return _a;
